...
export const VERSION_SUMMARY_KO =
  "시드 프롬프트에 지난 주 주제를 예시로 넣지 않습니다. Grok이 그 목록을 따라 쓰지 않습니다. 초안은 칸마다 이어서 씁니다. 이번 구간 성과는 후보. 문장 복사 금지. 수익은 계정 지급부터. 원글은 ChatGPT. 개인 관심 중심, 대중 생활 하루 1개. 아이폰 사파리. 생활은 캘리포니아, 글은 한국어. 발행은 태평양시 오후 2시부터.";
