...
export const VERSION_SUMMARY_KO =
  "수익은 계정 지급부터 시작, 글마다 나누지 않음. 3일 Planner가 Audience·성과·수익·현재 X·Memory를 읽음. 학습은 게시+Analytics만. 원글은 ChatGPT. 개인 관심 중심, 대중 생활 하루 1개. 3일 생성. 아이폰 사파리. 생활은 캘리포니아, 글은 한국어. 발행은 태평양시 오후 2시부터.";
