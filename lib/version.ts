...
export const VERSION_SUMMARY_KO =
  "원글은 ChatGPT. 개인 관심 원글이 중심. 대중 생활은 하루 1개. 3일 생성. 할당량은 유머로라도 채웁니다. 경험은 DNA·엔진만, 날조 금지. 아이폰 사파리에서 연결이 끊겨도 작업은 이어집니다. 생활은 캘리포니아, 글은 한국어. 발행은 태평양시 오후 2시부터 For You 간격.";
