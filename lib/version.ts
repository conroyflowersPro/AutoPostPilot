...
export const VERSION_SUMMARY_KO =
  "7일 생성은 Creator DNA가 RETURN·BRIDGE·REACH와 종류를 잠그고 Planner가 시각·Seed를 붙인 뒤 Writer가 쓰며 Semantic Judge가 PASS를 셉니다. REACH는 하루 1개·최대 2개입니다. 최근 흐름은 최대 30일의 실제 X Analytics만 사용합니다.";
