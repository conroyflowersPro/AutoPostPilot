 ...
 */
import { classifyEvidenceOrigin, classifyOwnTimelineOrigin } from "../origin-class";
...
export function classifyXPostOrigin(
  ...
  text: string,
  apRows: ApOriginHint[],
  opts?: { actionType?: string; ownAccount?: boolean },
  ...
  return classifyOwnTimelineOrigin({
    apMatched,
    actionType: opts?.actionType,
    ownAccount: opts?.ownAccount,
  });
}
