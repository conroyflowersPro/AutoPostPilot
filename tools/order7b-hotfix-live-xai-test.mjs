...
ok("H17. writer model gpt-5.6-sol, seed model grok-4.6", /V11_WRITER_MODEL = "gpt-5.6-sol"/.test(pipe) && /V11_SEED_MODEL = "grok-4.6"/.test(pipe));
ok("H18. index APP 11.6.1", /APP_VERSION = "11.6.1"/.test(index));
