...
ok("H17. writer model grok-4.6", /grok-4\.6/.test(pipe) && /grok-4\.6/.test(mod));
ok("H18. index APP v11", /11\.0\.0/.test(index));
ok("H19. index engine v11 order08", /v11_order08_wired_grok46/.test(index));
