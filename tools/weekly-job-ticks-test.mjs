...
ok("J20. last-week consumed experience skipped for generate", /isExperienceConsumedForUpcomingWeek/.test(job) && /지난주 소모 제외/.test(job));
ok("J21. exceptional activation still learned", /고참여는 학습/.test(job));
