...
ok("Q11. shipping 12.1.5", /APP_VERSION = "12.1.5"/.test(ver) && /APP_VERSION = "12.1.5"/.test(ix));
ok("Q12. calendar shows Analytics window", /Analytics \{analyticsN\}/.test(cal) && /X Analytics/.test(cal) && /loadBundledAnalyticsCoverage/.test(page));
