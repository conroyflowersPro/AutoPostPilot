...
Shipping version: `package.json` / `lib/version.ts` / weekly-plan `APP_VERSION` (currently **11.1.5**). Shown in the app header as `v11.1.5`. See [CHANGELOG.md](CHANGELOG.md).
