...
Shipping version: `package.json` / `lib/version.ts` / weekly-plan `APP_VERSION` (currently **11.2.1**). Shown in the app header as `v11.2.1`. See [CHANGELOG.md](CHANGELOG.md).
