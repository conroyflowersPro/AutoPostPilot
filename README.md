...
Shipping version: `package.json` / `lib/version.ts` / weekly-plan `APP_VERSION` (currently **11.6.1**). Shown in the app header as `v11.6.1`. See [CHANGELOG.md](CHANGELOG.md). Agent contract: [AGENTS.md](AGENTS.md).
