...
Shipping version: `package.json` / `lib/version.ts` / weekly-plan `APP_VERSION` (currently **11.4.4**). Shown in the app header as `v11.4.4`. See [CHANGELOG.md](CHANGELOG.md).
