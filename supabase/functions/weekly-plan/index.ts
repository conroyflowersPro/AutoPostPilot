...
const APP_VERSION = "10.0.0-order0b";
const WEEKLY_ENGINE_VERSION = "phased_v10_order0b_manual_leakage";
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    if (phase === "expand") {
      ...
      // ORDER 0B — Manual leakage guard on expand candidates
    ...
    if (phase === "select") {
      ...
      // ORDER 0B leakage filter on incoming seeds
