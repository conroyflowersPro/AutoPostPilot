 ...
 * Target volume: Planner locks the 7-day plan. Judge owns week count (PASS saved >= planned slots). Personal lock 3/day × 7 = 21 at 11/15/19 PT. Agent승 infers among those clocks.
