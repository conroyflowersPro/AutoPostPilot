...
const APP_VERSION = "10.0.0-order7b";
...
function compactSlot(
  ...
  // ORDER 7B: per-slot independent generation (dry_run in plan phase — no batch shared reasoning)
  const independent_generation: IndependentPostResult = generateIndependentPost(deep_generation, {
    dry_run: true,
  });
  return {
