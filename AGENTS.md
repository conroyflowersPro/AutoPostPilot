...
**New chat: read `architecture/operator-handoff-latest.md` first** (last thread 2026-08-17, shipped **v12.5.5**. Creator DNA renamed **Agent승** — absorb-Planner not fully wired).
