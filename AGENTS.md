...
**New chat: read `architecture/operator-handoff-latest.md` first** (last thread 2026-08-19, **this branch v12.12.21** public seed directions. main is v12.12.20 EXPERIENCE grounding — do not deploy until **배포해**).
