...
**New chat: read `architecture/operator-handoff-latest.md` first** (last thread 2026-08-19, **main v12.12.19** public X exploration budget shipped. Next: EXPERIENCE grounding as **v12.12.20**. Do not deploy until **배포해**).
