...
**New chat: read `architecture/operator-handoff-latest.md` first** (last thread 2026-08-19, **this branch v12.12.20** EXPERIENCE grounding. main is v12.12.19 public X exploration budget — do not deploy until **배포해**).
