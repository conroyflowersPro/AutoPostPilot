...
**New chat: read `architecture/operator-handoff-latest.md` first** (last thread 2026-08-21, **this branch v12.12.23** personal @Seung4680 clocks 11·15·19 PT / 3 per day / 4h. main is v12.12.22 lived originals — do not deploy until **배포해**).
