...
- `architecture/collections/writing-theories.md` — 닫는 형식. W1 Fluency. W2 의도적 불완전성. W3 구체성/장면 우선. W4 1인칭 경험 경계. W5 저항 제거(수단). W6–W9 empty. Do not mix with viral cards until all writing cards are in.
