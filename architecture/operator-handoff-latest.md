...
- `architecture/collections/writing-theories.md` — 닫는 형식. W1–W8. W9 empty. Theory names are for Agent승 only, never in post text. Do not mix with viral cards until all writing cards are in.
